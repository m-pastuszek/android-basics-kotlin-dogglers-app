...
class DogCardAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        ...
        val layoutType: Int = when(layout) {
            Layout.GRID -> R.layout.grid_list_item
            else -> R.layout.vertical_horizontal_list_item
        }

        val adapterLayout: View = LayoutInflater.from(parent.context).inflate(layoutType, parent, false)
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        holder.dogImage.setImageDrawable(resources?.getDrawable(dog.imageResourceId, context?.theme))
